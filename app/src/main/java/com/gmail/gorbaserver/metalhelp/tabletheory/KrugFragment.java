 ...
 */
public class KrugFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v = inflater.inflate(R.layout.fragment_krug, null);

        dbMetal = new DBMetal(getContext());
        dbMetal.open();


        lvKrug = (ListView) v.findViewById(R.id.lvKrugFragment);

        ArrayList<MetalItem> items = dbMetal.getMetalItemsByTypeName(getString(R.string.type_krug));
        ...
        lvKrug.setAdapter(simpleAdapter);
