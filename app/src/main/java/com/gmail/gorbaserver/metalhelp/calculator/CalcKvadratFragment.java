...
public class CalcKvadratFragment extends CalculatorFragment implements View.OnClickListener {
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        tvHeader.setText(getString(R.string.calc_kvadrat_header));
        tvDiameter.setText(getString(R.string.thickness_mm));
